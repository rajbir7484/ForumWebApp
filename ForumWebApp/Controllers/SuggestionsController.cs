...
namespace ForumWebApp.Controllers
{
    ...
    public class SuggestionsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("SuggestionID,Name,EmailID,SuggestionDate,SuggestionText")] Suggestion suggestion)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("SuggestionID,Name,EmailID,SuggestionDate,SuggestionText")] Suggestion suggestion)
        {
