        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SuggestionText = table.Column<string>(maxLength: 2000, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuestionText = table.Column<string>(maxLength: 2000, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    AnswerID = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    AnswerText = table.Column<string>(maxLength: 2000, nullable: false),
                    UserName = table.Column<string>(maxLength: 100, nullable: true),
            ...
            var sql = Path.Combine(".\\Scripts", @"forums.sql");
